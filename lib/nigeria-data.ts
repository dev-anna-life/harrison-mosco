...
// Official dataset for CAC Director KYC and Address validation
// =========================================================
...
export const NIGERIA_STATES_AND_LGAS: Record<string, string[]> = {
  ...
  Katsina: [
    ...
    "Dan Musa", "Daura", "Dutsin Ma", "Faskari", "Funtua", "Ingawa", "Jibia", "Kafur", "Kaita",
  ...
  Ogun: [
    ...
    "Ilugun-Alaro", "Imeko Afon", "Ipokia", "Obafemi Owode", "Odeda", "Odogbolu", "Ogun Waterside",
    "Remo North", "Shagamu"
  ],
  Ondo: [
...
export const NIGERIAN_STATES = Object.keys(NIGERIA_STATES_AND_LGAS).sort();
