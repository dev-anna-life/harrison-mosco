...
export default function AboutPage() {
  return (
    <div className="bg-[#0a0e17] text-white min-h-screen relative overflow-hidden">
      ...
      {/* Hero */}
      <section className="py-14 sm:py-28 border-b border-slate-800 relative z-10 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4 sm:space-y-6 relative z-10">
          ...
          <Reveal type="up" delay={150} duration={0.8}>
            ...
            <p className="text-sm sm:text-lg lg:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mt-3 sm:mt-4 font-normal">
      ...
      <section className="py-16 sm:py-32 bg-[#070b13] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 sm:space-y-28 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <Reveal type="right" delay={200} duration={0.8} className="lg:col-span-6 space-y-4 sm:space-y-6">
              <span className="text-[11px] sm:text-xs font-black text-[#FDC902] uppercase tracking-widest block">
                Principal Leadership &amp; Governance
              </span>
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-white leading-tight">
                Meet Harrison Mosco
              </h2>
              <h3 className="text-base sm:text-xl text-[#FDC902] font-bold">
              ...
              <div className="space-y-3 sm:space-y-4 pt-1 sm:pt-2">
                <div className="p-4 rounded-xl sm:rounded-2xl bg-slate-900/80 border border-slate-800 space-y-1.5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            <Reveal type="left" duration={0.8} className="lg:col-span-6 space-y-4 sm:space-y-6 order-2 lg:order-1">
              <span className="text-[11px] sm:text-xs font-black text-[#FDC902] uppercase tracking-widest block">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            ...
            <Reveal type="right" delay={200} duration={0.8} className="lg:col-span-6 space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2.5 sm:space-y-3 pt-2 text-xs sm:text-base text-slate-200 font-bold">
          ...
          <Reveal type="up" delay={200} duration={0.8}>
            <div className="p-5 sm:p-14 rounded-2xl sm:rounded-3xl bg-[#0f172a] border border-slate-800 shadow-2xl space-y-6 sm:space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 max-w-4xl mx-auto text-sm">
                <div className="p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-[#0a0e17] border border-slate-800 space-y-2.5 sm:space-y-3">
                  <div className="flex items-center gap-2.5 text-white font-black text-sm sm:text-base">
                    <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-[#FDC902] shrink-0" />
                  ...
                  <span className="inline-block text-[10px] sm:text-xs font-bold text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded-md border border-emerald-500/30">
                ...
                <div className="p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-[#0a0e17] border border-slate-800 space-y-2.5 sm:space-y-3">
                  <div className="flex items-center gap-2.5 text-white font-black text-sm sm:text-base">
                    <Phone className="w-4 h-4 sm:w-5 sm:h-5 text-[#FDC902] shrink-0" />
