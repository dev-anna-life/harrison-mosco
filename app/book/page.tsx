        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <Reveal type="down" duration={0.6}>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FDC902]/10 border border-[#FDC902]/30 text-[#FDC902] text-xs font-black uppercase tracking-wider">
              <Calendar className="w-4 h-4 text-[#FDC902]" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <Reveal type="left" duration={0.8} className="lg:col-span-7">
              <div className="bg-[#0f172a] p-8 sm:p-12 rounded-3xl border border-slate-800 shadow-2xl">
                {submitted ? (
                  <div className="text-center space-y-6 py-8">
                    <div className="w-16 h-16 bg-emerald-500/20 text-emerald-400 rounded-full flex items-center justify-center mx-auto">
                      <CheckCircle2 className="w-8 h-8" />
                    </div>
                    <h3 className="text-2xl sm:text-3xl font-black text-white">Consultation Request Received</h3>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-3 px-8 py-4 bg-[#FDC902] hover:bg-amber-400 text-slate-950 font-black rounded-xl text-base transition-all shadow-[0_6px_25px_rgba(253,201,2,0.25)]"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <span className="block text-sm font-black uppercase tracking-wider text-[#FDC902]">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-5 py-4 bg-[#0a0e17] border border-slate-700 rounded-xl text-white font-medium focus:border-[#FDC902] focus:outline-none text-sm sm:text-base"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-5 py-4 bg-[#0a0e17] border border-slate-700 rounded-xl text-white font-bold focus:border-[#FDC902] focus:outline-none text-sm sm:text-base"
                      >
                    ...
                    <button
                      type="submit"
                      className="w-full py-4.5 bg-[#FDC902] hover:bg-amber-400 text-slate-950 font-black text-base rounded-xl transition-all shadow-[0_8px_30px_rgba(253,201,2,0.25)] flex items-center justify-center gap-2"
                    >
                      <Phone className="w-5 h-5" />
            ...
            <Reveal type="right" delay={200} duration={0.8} className="lg:col-span-5 space-y-6">
              <HoverCard>
                <div className="bg-[#0f172a] p-8 sm:p-10 rounded-3xl border border-slate-800 space-y-6 shadow-2xl">
                  <span className="text-xs font-black uppercase tracking-widest text-[#FDC902] block">
                    Instant Channel
                  </span>
                  <h3 className="text-2xl font-black text-white">Prefer to chat immediately?</h3>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full py-4 text-center bg-slate-900 hover:bg-slate-800 border-2 border-slate-700 hover:border-[#FDC902]/60 text-white font-bold rounded-xl text-sm transition-all"
                  >
              ...
              <div className="p-6 bg-[#0a0e17] rounded-2xl border border-slate-800 text-xs text-slate-400 space-y-2">
                <span className="text-white font-bold block text-sm">Head Office Location:</span>
                <p>Rockville Place, SARS Road, Port Harcourt, Rivers State, Nigeria.</p>
                <p className="pt-2 text-slate-500">Phone: +234 813 709 2154 • Email: support@harrisonmosco.ng</p>
              </div>
            </Reveal>
          </div>
        </div>
